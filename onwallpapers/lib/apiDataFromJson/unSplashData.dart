...
//Eb3g94lILaDCXGVvrdbtIxbUxNKwTIQNDWakIbor7CE

import 'dart:convert';

UnSplashUnits unSplashUnitsFromJson(String str) =>
    UnSplashUnits.fromJson(json.decode(str));
...
class Category {
  ...
  factory Category.fromJson(Map<String, dynamic> json) => Category(
        slug:
            'slug' /*json['slug']*/, //hardcoded because the api sometimes returns null and crashes the app
        prettySlug:
            'pretty_slug' /*json['pretty_slug']*/, //hardcoded because the api sometimes returns null and crashes the app
      );
