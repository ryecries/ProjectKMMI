import 'package:onwallpapers/screens/search_view.dart';
import 'package:provider/provider.dart';
import 'package:onwallpapers/screens/category.dart';
import 'package:onwallpapers/screens/main_page.dart';
import 'package:onwallpapers/screens/settings.dart';
import 'package:onwallpapers/theme/theme_state.dart';
import 'package:onwallpapers/utils/exapndingnav.dart';
    ...
    return Theme(
      ...
      child: Scaffold(
        appBar: AppBar(
            ...
            actions: <Widget>[
              IconButton(
                icon: Icon(Icons.search, color: state.themeData.accentColor),
                onPressed: () async {
